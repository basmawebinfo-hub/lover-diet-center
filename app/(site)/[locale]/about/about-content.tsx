      ...
      <section className="bg-neutral-50 py-16 px-4 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {/* Was "Create Free Account" pointing at /sign-up. Booking is the
                action this page is asking for — an account is not a
                prerequisite for it, so don't make one the first step. */}
            <BookConsultationButton
              label={t(locale, 'Book a Consultation', 'احجز استشارة')}
              className="px-8 py-4"
            />
            <a
              href={WHATSAPP_DIRECT}
