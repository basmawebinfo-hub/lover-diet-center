      ...
      <section className="bg-gradient-to-br from-[#f0faf7] to-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-neutral-900 mb-6 leading-tight">
            ...
            <span className="text-[#1A7A6E]">On Your Side</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/sign-up"
              className="inline-flex items-center justify-center gap-2 border-2 border-[#1A7A6E] text-[#1A7A6E] font-semibold px-8 py-4 rounded-2xl hover:bg-[#1A7A6E]/5 transition-colors"
            >
              Create Free Account
            </Link>
          </div>
